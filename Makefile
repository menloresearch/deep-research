...
## Start all services
.PHONY: serve-all
serve-all: serve-mock serve-simple serve-flashrag serve-sandbox

## Start mock retriever
.PHONY: serve-mock
serve-mock:
	@echo "Starting mock retriever on port 8003..."
	PYTHONPATH=. uvicorn deploy.serving.serve_mock_retriever:app --host 0.0.0.0 --port 8003 &

## Start simple retrieval server
.PHONY: serve-simple
serve-simple:
	@echo "Starting simple retrieval server on port 8002..."
...
serve-flashrag:
	@echo "Starting flashrag retriever on port 8001..."
...
.PHONY: serve-sandbox
serve-sandbox:
	@echo "Starting sandbox environment on port 8005..."

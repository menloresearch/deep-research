# Stolen from https://github.com/Alibaba-NLP/WebAgent
...
def eval_result(input_path, output_path):
    ...
    Parameters:
        input_path (str): Path to the input predictions file (CSV or JSONL).
    ...
    evaluator = load_evaluator(
        ...
        llm=ChatOpenAI(
            ...
            default_headers={
                ...
                "X-Title": "WebWalker QA Evaluation",  # Optional, shows in rankings
            },
        ),
    )
    data_list = []
        ...
        with open(input_path, newline="", encoding="utf-8") as csvfile:
            ...
            for row in reader:
                item = {
                    ...
                    "answer": row.get("gold_answer", ""),  # ground truth
                    "pred": row.get("answer", ""),  # model prediction
                }
                if item["question"] not in visited and item["answer"]:
        ...
        with open(input_path, "r", encoding="utf-8") as f:
            for line in f:
                ...
                if data["question"] not in visited:
                    data["answer"] = info_adic.get(data["question"], [data.get("answer", None), None])[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        type=str,
        default="webwalker_input.csv",
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default="webwalkerqa_main_report.json",
    )
